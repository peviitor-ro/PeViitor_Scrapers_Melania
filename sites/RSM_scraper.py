...
#
# New scraper for -> RSM
# RSM page -> https://www.rsm.global/romania/ro/campaign/joburi-disponibile
#
#
...
company_name = 'RSM'  # add test comment
data_list = req_and_collect_data_()
scrape_and_update_peviitor(company_name, data_list)

print(update_logo('RSM',
